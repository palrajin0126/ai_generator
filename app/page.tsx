...
const LandingPage = () => {
  ...
  const generateLandingPage = async () => {
    const response = await fetch('/api/generateLandingPage', {
      method: 'POST',
      headers: {
  ...
  return (
    <div>
      <Head>
        <title>Generate Landing Page</title>
      </Head>
      <div className="container mx-auto p-4">
        <h1 className="text-2xl font-bold mb-4">Generate E-commerce Landing Page</h1>
        <div className="mb-4">
